...
class Population {
    private:
        int p, psize, sick, r1, r2, step, vax;                       // cut some of these
...
int mdain() {
    ...
    for(n=10; n<=50; n=n+10){                                   // different population sizes
        ...
        myfile << "Disease ran its course by day " << pop1.getstep()-1 << ". Total affected: " << 
    ...
    for(p=0; p<=100; p=p+10){
        ...
        myfile << "Disease ran its course by day " << pop2.getstep()-1 << ". Total affected: " << 
    ...
    myfile << "Vaccination Percentage in range 10-100" <<  endl;
    myfile << "Static parameters: " << endl;
    myfile << "Transfer probability: ." << p << endl; 
    myfile << "Population: " << n << endl << endl;
    for(percent=10; percent<=100; percent=percent+5){
        Population pop3(n);
        ...
        myfile << "Disease ran its course by day " << pop3.getstep()-1 << ". Total affected: " << 
