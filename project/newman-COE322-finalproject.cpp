...
void generateDiseaseInfo(int n, int p, int infectionLength, int interactionsPerDay) {
    bool flag;
    int percent, affected;
    ofstream f;
    f.open("DiseasePropagationData.txt");
...
int main() {
    ...
    generateDiseaseInfo(n,p,days,interactions);
    cout << "Your disease simulation has been run!" << endl;
    cout << "See the file called DiseasePropagationData.txt for results" << endl << endl; 
